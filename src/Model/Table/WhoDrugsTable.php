 ...
 * WhoDrugs Model
 *
 * @method \App\Model\Entity\WhoDrug newEmptyEntity()
 * @method \App\Model\Entity\WhoDrug newEntity(array $data, array $options = [])
 ...
 * @method \App\Model\Entity\WhoDrug[] patchEntities(iterable $entities, array $data, array $options = [])
 * @method \App\Model\Entity\WhoDrug|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\WhoDrug saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\WhoDrug[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\WhoDrug[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \App\Model\Entity\WhoDrug[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\WhoDrug[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
 *
...
class WhoDrugsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->maxLength('drug_record_number', 255)
        ...
        $validator
            ->scalar('drug_name')
            ->maxLength('drug_name', 4294967295)
