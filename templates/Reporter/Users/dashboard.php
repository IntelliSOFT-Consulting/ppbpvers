...
<section>
  <div class="row-fluid">
    <div class="span8">
      ...
      <?php if ($this->request->getSession()->read('Auth.User.health_program') == "Cancer/Oncology program") { ?>
        <div class="row-fluid">
          ...
          <div class="span4 formback" style="padding: 4px;">
            ...
            if ($this->request->getSession()->read('Auth.User.user_type') != 'Public Health Program') echo $this->Form->postLink('Report SADR', array('controller' => 'sadrs', 'action' => 'add'), array('class' => 'btn btn-success pull-right btn-mini pull-right'), __('Report New ADR?'));
          ...
          <div class="span4 formbackm" style="padding: 4px;">
            ...
            if ($this->request->getSession()->read('Auth.User.user_type') != 'Public Health Program')   echo $this->Form->postLink('Report Medication Error', array('controller' => 'medications', 'action' => 'add'), array('class' => 'btn btn-success pull-right btn-mini'), __('Report New Medication Error?'));
            ?>
          </div>
        </div>
      <?php } else { ?>
        <div class="row-fluid">
          ...
          <div class="span4 formbacka" style="padding: 4px;">
            ...
            foreach ($aefis as $aefi) {
              if ($aefi['Aefi']['submitted'] > 1) {
                ...
                echo "&nbsp;";
                if ($this->request->getSession()->read('Auth.User.user_type') == 'County Pharmacist' && $aefi['Aefi']['user_id'] != $this->request->getSession()->read('Auth.User.id')) {
            ...
            if ($this->request->getSession()->read('Auth.User.user_type') != 'Public Health Program')   echo $this->Form->postLink('Report AEFI', array('controller' => 'aefis', 'action' => 'add'), array('class' => 'btn btn-success pull-right btn-mini'), __('Report  New AEFI?'));
            ?>
          ...
          <div class="span4 formbackp" style="padding: 4px;">
            ...
            if ($this->request->getSession()->read('Auth.User.user_type') != 'Public Health Program')   echo $this->Form->postLink('Report  PQHPT', array('controller' => 'pqmps', 'action' => 'add'), array('class' => 'btn btn-success pull-right btn-mini'), __('ReportPoor-Quality Health Products and Technologies?'));
            ?>
          </div>
        ...
        <?php
            ...
            <div class="span4 formbacka" style="padding: 4px;">
              ...
              foreach ($ce2bs as $ce) {
                if ($ce['Ce2b']['submitted'] > 1) {
                  ...
                  echo "&nbsp;";
                  if ($this->request->getSession()->read('Auth.User.user_type') == 'County Pharmacist' && $ce['Ce2b']['user_id'] != $this->request->getSession()->read('Auth.User.id')) {
            ...
            <div class="span4 formbacka" style="padding: 4px;">
              ...
              foreach ($serious_aefis as $saefi) {
                if ($saefi['Aefi']['submitted'] > 1) {
                  ...
                  echo "&nbsp;";
                  if ($this->request->getSession()->read('Auth.User.user_type') == 'County Pharmacist' && $saefi['Aefi']['user_id'] != $this->request->getSession()->read('Auth.User.id')) {
                    echo $this->Form->postLink('<span class="label label-inverse tooltipper" data-toggle="tooltip" title="Add Investigation up report"> <i class="fa fa-eye" aria-hidden="true"></i></span>', array('controller' => 'aefis', 'action' => 'investigation', $saefi['Aefi']['id']), array('escape' => false), __('Add a Investigation report?'));
                  }
                  echo "</li>";
                } else {
          ...
          <?php if ($this->request->getSession()->read('Auth.User.user_type') == 'County Pharmacist') { ?>
            <div class="span4 formbacka" style="padding: 4px;">
              ...
              // if ($this->request->getSession()->read('Auth.User.user_type') != 'Public Health Program')   echo $this->Form->postLink('Report SAEFI', array('controller' => 'saefis', 'action' => 'add'), array('class' => 'btn btn-success pull-right btn-mini'), __('Report  New SAEFI?'));
              ?>
