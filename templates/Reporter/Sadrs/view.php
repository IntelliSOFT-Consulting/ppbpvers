    ...
    <div class="tab-pane active" id="formview">
      <div class="row-fluid">
        ...
        <div class="span2">
          ...
          <hr>
          <?php
          if ($this->request->getSession()->read('Auth.User.user_type') != 'Public Health Program') echo $this->Form->postLink('<span class="btn btn-warning btn-block tooltipper" data-toggle="tooltip" title="Add follow up report">  <b>Follow-up</b> <i class="fa fa-plus" aria-hidden="true"></i> </span>', array('controller' => 'sadrs', 'action' => 'followup', $sadr['id']), array('escape' => false), __('Add a followup report?'));
          ?>
