            ...
            <div class="formback">
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td style="width: 25%;"><strong><?php echo $sadr['date_of_birth']; ?></strong></td>
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td style="width: 25%;"><strong><?php echo $sadr['date_of_onset_of_reaction']; ?></strong></td>
                    ...
                    <tr>
                        ...
                        <td style="width: 70%;"><strong><?php echo $sadr['description_of_reaction'] ?></strong>
                            <?php
                            // foreach ($sadr['sadr_description'] as $sadrDescription) :
