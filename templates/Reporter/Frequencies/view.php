...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Frequency'), ['action' => 'edit', $frequency->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Frequency'), ['action' => 'delete', $frequency->id], ['confirm' => __('Are you sure you want to delete # {0}?', $frequency->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Frequencies'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Frequency'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="frequencies view content">
            ...
            <div class="related">
                ...
                <?php if (!empty($frequency->ce2b_list_of_drugs)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($frequency->ce2b_list_of_drugs as $ce2bListOfDrugs) : ?>
                        <tr>
            ...
            <div class="related">
                ...
                <?php if (!empty($frequency->sadr_list_of_medicines)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($frequency->sadr_list_of_medicines as $sadrListOfMedicines) : ?>
                        <tr>
