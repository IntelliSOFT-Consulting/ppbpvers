 ...
 * @var string[]|\Cake\Collection\CollectionInterface $padrs
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $padrListOfMedicine->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $padrListOfMedicine->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="padrListOfMedicines form content">
            ...
            <fieldset>
                <legend><?= __('Edit Padr List Of Medicine') ?></legend>
                <?php
