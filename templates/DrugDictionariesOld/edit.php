...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $drugDictionariesOld->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $drugDictionariesOld->id), 'class' => 'side-nav-item']
            ) ?>
            <?= $this->Html->link(__('List Drug Dictionaries Old'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="drugDictionariesOld form content">
            <?= $this->Form->create($drugDictionariesOld) ?>
            <fieldset>
                <legend><?= __('Edit Drug Dictionaries Old') ?></legend>
                <?php
