        ...
        <div class="row-fluid">
            ...
            <fieldset>
                ...
                echo $this->Form->control('sms', array(
                    ...
                    'between' => '<div class="controls">', 'placeholder' => 'sms', 'class' => 'control-xxlarge',
                ));
                echo $this->Form->control('type', array('type' => 'select', 'empty' => true, 'options' => array('notification' => 'notification', 'email' => 'email', 'notification email' => 'notification email')));
