...
<!-- Content
    ================================================== -->
<h3>Content Management System <small>(FREQUENCIES)</small></h3>
...
<div class="row-fluid" style="margin-bottom: 9px;">
    ...
    <div class="span10 columns">
        ...
        <div class="row-fluid">
            <div class="span2 columns">
                <?php
                echo $this->Html->link('Add A Frequency', array('controller' => 'frequencies', 'action' => 'add', 'admin' => true), array('class' => 'btn btn-info'));
                ?>
            </div>
                ...
                <p>
                    ...
                    echo $this->Paginator->counter(
                        __('Page <span class="badge">{{page}}</span> of <span class="badge">{{pages}}</span>, 
                                showing <span class="badge">{{current}}</span> Frequencies out of 
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        foreach ($frequencies as $frequency) : ?>
                            <tr>
                                <td><?php echo h($frequency['id']); ?>&nbsp;</td>
                                <td><?php echo h($frequency['value']); ?>&nbsp;</td>
                                <td><?php echo h($frequency['name']); ?>&nbsp;</td>
                                <td>
                                    <?php echo $this->Html->link(
                                        '<span class="label label-info"><i class="icon-pencil icon-white"></i> Edit</span>',
                                        array('controller' => 'frequencies', 'action' => 'edit', $frequency['id']),
                                        array('escape' => false)
                                    ); ?>&nbsp;
                                    <?php echo $this->Form->postLink(
                                        __('<span class="label label-important"><i class="icon-trash icon-white"></i> Delete</span>'),
                                        array('action' => 'delete', $frequency['id']),
                                        array('escape' => false),
                                        __('Are you sure you want to delete # %s?', $frequency['id'])
                                    ); ?>&nbsp;
                                </td>
                            </tr>
                        <?php endforeach; ?>
