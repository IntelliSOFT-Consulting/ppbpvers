            ...
            <div class="contentpadded">
                ...
                <div class="page-header">
                    <div class="styled_title">
                        <h2>Update <?php //echo $this->request->data['User']['username'] . '\'s' 
                                    ?> Details</h2>
                    </div>
                </div>
                <?php
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <?php
                        echo $this->Form->control('username', array('label' => array('class' => 'control-label', 'text' => 'Username'),));
                        ...
                        echo $this->Form->control('role_id', array('label' => array('class' => 'control-label', 'text' => 'Group/Role'),));
                        ?>
                    </div>
                    <div class="span4"><?php
                                        echo $this->Form->control('password', array('label' => array('class' => 'control-label required', 'text' => 'New Password' . ' <span style="color:red;">*</span>', 'escape' => false),));
                                        echo $this->Form->control('confirm_password', array(
                                            'type' => 'password',
                                            'label' => array('class' => 'control-label required', 'text' => 'Confirm New Password' . ' <span style="color:red;">*</span>', 'escape' => false),
                                        ));
                                        echo $this->Form->control('is_active', array('label' => array('class' => 'control-label', 'text' => 'Is Active?'),));
