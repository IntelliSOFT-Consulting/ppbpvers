    ...
    <div class="column-responsive column-80">
        <div class="designations view content">
            ...
            <div class="related">
                ...
                <?php if (!empty($designation->aefis)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($designation->aefis as $aefis) : ?>
                        <tr>
                            <td><?= h($aefis->id) ?></td>
            ...
            <div class="related">
                ...
                <?php if (!empty($designation->aggregates)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($designation->aggregates as $aggregates) : ?>
                        <tr>
            ...
            <div class="related">
                ...
                <?php if (!empty($designation->ce2bs)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($designation->ce2bs as $ce2bs) : ?>
                        <tr>
                            <td><?= h($ce2bs->id) ?></td>
            ...
            <div class="related">
                ...
                <?php if (!empty($designation->devices)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($designation->devices as $devices) : ?>
                        <tr>
                            <td><?= h($devices->id) ?></td>
            ...
            <div class="related">
                ...
                <?php if (!empty($designation->medications)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($designation->medications as $medications) : ?>
                        <tr>
            ...
            <div class="related">
                ...
                <?php if (!empty($designation->padrs)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($designation->padrs as $padrs) : ?>
                        <tr>
                            <td><?= h($padrs->id) ?></td>
            ...
            <div class="related">
                ...
                <?php if (!empty($designation->pqmps)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($designation->pqmps as $pqmps) : ?>
                        <tr>
                            <td><?= h($pqmps->id) ?></td>
            ...
            <div class="related">
                ...
                <?php if (!empty($designation->sadr_followups)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($designation->sadr_followups as $sadrFollowups) : ?>
                        <tr>
            ...
            <div class="related">
                ...
                <?php if (!empty($designation->sadrs)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($designation->sadrs as $sadrs) : ?>
                        <tr>
                            <td><?= h($sadrs->id) ?></td>
            ...
            <div class="related">
                ...
                <?php if (!empty($designation->saefis)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($designation->saefis as $saefis) : ?>
                        <tr>
                            <td><?= h($saefis->id) ?></td>
            ...
            <div class="related">
                ...
                <?php if (!empty($designation->transfusions)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($designation->transfusions as $transfusions) : ?>
                        <tr>
