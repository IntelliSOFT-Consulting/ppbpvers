...
<ichicsr lang="en">
    ...
    <safetyreport lang="en">
        ...
        <serious><?php
			...
			?></serious>
        <seriousnessdeath><?php echo ($sadr['serious_reason'] == 'Death') ? 1 : 2; ?></seriousnessdeath>
        <seriousnesslifethreatening><?php echo ($sadr['serious_reason'] == 'Life threatening') ? 1 : 2; ?></seriousnesslifethreatening>
        <seriousnesshospitalization><?php echo ($sadr['serious_reason'] == 'Hospitalization/ Prolonged Hospitalization') ? 1 : 2; ?></seriousnesshospitalization>
        <seriousnessdisabling><?php echo ($sadr['serious_reason'] == 'Disability') ? 1 : 2; ?></seriousnessdisabling>
        <seriousnesscongenitalanomali><?php echo ($sadr['serious_reason'] == 'Congenital anomality') ? 1 : 2; ?></seriousnesscongenitalanomali>
        <seriousnessother><?php echo ($sadr['serious_reason'] == 'Other Medically Important Reason') ? 1 : 2; ?></seriousnessother>
        <receivedateformat>102</receivedateformat>
        <receivedate><?php echo (!empty($sadr['reporter_date'])) ?  date('Ymd', strtotime($sadr['reporter_date'])) : date('Ymd', strtotime($sadr['created'])); ?></receivedate>
        <receiptdateformat>102</receiptdateformat>
        <receiptdate><?php echo (!empty($sadr['reporter_date'])) ?  date('Ymd', strtotime($sadr['reporter_date'])) : date('Ymd', strtotime($sadr['created'])); ?></receiptdate>
        <additionaldocument><?php
			if (isset($sadr['attachments']) && count($sadr['attachments']) > 0) {
				echo 1;
			} else {
				echo 2;
			}
        ...
        <medicallyconfirm><?php
            if (!in_array($sadr['designation_id'], [26, 27])) {
                echo 1;
            } else { echo 2;}
		?></medicallyconfirm>
        ...
        <primarysource>
            ...
            <reporterorganization><?php echo $sadr['name_of_institution']; ?></reporterorganization>
            <reporterdepartment/>
            <reporterstreet><?php echo $sadr['reporter_phone']; ?></reporterstreet>
            <reportercity/>
            <reporterstate/>
            <reporterpostcode/>
        ...
        <patient>
            ...
            <resultstestsprocedures><?php echo $sadr['lab_investigation']; ?></resultstestsprocedures>
            <patientdeath>
            ...
            <reaction>
                ...
                <reactionmeddrallt><?php echo $sadr['report_title']; ?></reactionmeddrallt>
            ...
            <drug>
                ...
                <drugstructuredosageunit><?php
					echo $sadrListOfDrug['doses_entity']['icsr_code'];
                ...
                <actiondrug><?php
					...
					if (!empty($sadr['action_taken']) && $sadrListOfDrug['suspected_drug'] == 1) echo $actions[strtolower($sadr['action_taken'])];
				?></actiondrug>
            ...
            <summary>
                ...
                <reportercomment><?php echo $sadr['any_other_comment']; ?></reportercomment>
