...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $disproportionality->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $disproportionality->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="disproportionalities form content">
            ...
            <fieldset>
                <legend><?= __('Edit Disproportionality') ?></legend>
                <?php
