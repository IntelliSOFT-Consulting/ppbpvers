...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $drugDictionary->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $drugDictionary->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="drugDictionaries form content">
            ...
            <fieldset>
                <legend><?= __('Edit Drug Dictionary') ?></legend>
                <?php
