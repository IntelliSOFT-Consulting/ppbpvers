                        ...
                        <td class="actions">
                            ...
                            if ($aefi['submitted'] > 1) {
                                echo $this->Html->link(
                                    ...
                                    array('controller' => 'saefis', 'action' => 'view', $aefi['id']),
                                    array('escape' => false)
                                );
                                echo "&nbsp;";
                                if (($prefix == 'manager' || $prefix == 'reviewer') && $aefi['copied'] == 2) echo $this->Html->link(
                                    ...
                                    array('controller' => 'saefis', 'action' => 'edit', $aefi['id']),
                                    array('escape' => false)
                                );
                                echo "&nbsp;";
                                if (($prefix == 'manager' || $prefix == 'reviewer') && $aefi['copied'] == 0) echo $this->Form->postLink('<span class="badge badge-success tooltipper" data-toggle="tooltip" title="Copy & Edit"> <i class="fa fa-copy" aria-hidden="true"></i> Copy </span>', array('controller' => 'saefis', 'action' => 'copy', $aefi['id']), array('escape' => false), __('Create a clean copy to edit?'));
                                echo $this->Html->link(
                                    '<span class="label label-warning tooltipper" title="View"><i class="fa fa-refresh" aria-hidden="true"></i> Archive </span>',
                                    array('controller' => 'saefis', 'action' => 'archive', $aefi['id']),
                                    array('escape' => false),
                            ...
                            if (($prefix == 'reporter' || $prefix == 'manager') && $aefi['submitted'] == 0 && $this->request->getSession()->read('Auth.User.user_type') != 'Public Health Program') {
                                echo "&nbsp;";
                                echo $this->Form->postLink('<span class="label label-warning tooltipper" data-toggle="tooltip" title="Delete"> <i class="fa fa-trash" aria-hidden="true"></i> Delete </span>', array('controller' => 'saefis', 'action' => 'delete', $aefi['id']), array('escape' => false), __('Are you sure you want to delete this report? 
