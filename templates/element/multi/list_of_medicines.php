...
echo $this->Html->script('list_of_medicines_v3', array('inline' => false));
  ...
  <div class="span12">
    <table id="listOfMedicinesTable" class="table table-bordered table-condensed table-pvborder">
      ...
      <tbody>
        <?php
        // $i = 0;
        if (!empty($this->request->getData('sadr_list_of_medicines'))) {
          for ($i = 0; $i <= count($this->request->getData('sadr_list_of_medicines')) - 1; $i++) {
        ?>
            <tr>
              <td><?= $i + 1; ?></td>
              <td><?php
                  echo $this->Form->control('sadr_list_of_medicines.' . $i . '.id');
                  echo $this->Form->control('sadr_list_of_medicines.' . $i . '.drug_name', array(
                    'label' => false,
                    'between' => false,
                    'after' => false,
                    'class' => 'span11',
              ...
              <td><?php
                  echo $this->Form->control('sadr_list_of_medicines.' . $i . '.brand_name', array(
                    'label' => false,
                    'between' => false,
                    'after' => false,
                    'class' => 'span11',
              ...
              <td>
                <?php
                echo $this->Form->control('sadr_list_of_medicines.' . $i . '.batch_no', array(
                  'label' => false,
                  'between' => false,
                  'after' => false,
                  'class' => 'span11',
              ...
              <td>
                <?php
                echo $this->Form->control('sadr_list_of_medicines.' . $i . '.manufacturer', array(
                  'label' => false,
                  'between' => false,
                  'after' => false,
                  'class' => 'span11',
              ...
              <td>
                <?php
                echo $this->Form->control('sadr_list_of_medicines.' . $i . '.dose', array(
                  'type' => 'text',
                  'label' => false,
                  'between' => false,
                  'after' => false,
              ...
              <td>
                <?php
                echo $this->Form->control('sadr_list_of_medicines.' . $i . '.dose_id', array(
                  'empty' => true,
                  'label' => false,
                  'between' => false,
                  'class' => 'span12',
              ...
              <td>
                <?php
                echo $this->Form->control('sadr_list_of_medicines.' . $i . '.route_id', array(
                  'empty' => true,
                  'label' => false,
                  'between' => false,
                  'after' => false,
              ...
              <td>
                <?php
                echo $this->Form->control('sadr_list_of_medicines.' . $i . '.frequency_id', array(
                  'empty' => true,
                  'label' => false,
                  'between' => false,
                  'after' => false,
                ...
                ?>
                <?php echo $this->Form->label('sadr_list_of_medicines.' . $i . '.frequency_other', 'If Other specify', ['class' => 'small-label']) ?>
                <?php echo $this->Form->control('sadr_list_of_medicines.' . $i . '.frequency_other', [
                  'empty' => true,
                  'label' => false,
                  'between' => false,
                  'after' => false,
              ...
              <td><?php
                  echo $this->Form->control('sadr_list_of_medicines.' . $i . '.start_date', array(
                    'type' => 'text',
                    'label' => false,
                    'between' => false,
                    'after' => false,
              ...
              <td>
                <?php
                echo $this->Form->control('sadr_list_of_medicines.' . $i . '.stop_date', array(
                  'type' => 'text',
                  'label' => false,
                  'between' => false,
                  'after' => false,
              ...
              <td>
                <?php
                echo $this->Form->control('sadr_list_of_medicines.' . $i . '.indication', array(
                  'type' => 'text',
                  'label' => false,
                  'between' => false,
                  'after' => false,
              ...
              <td>
                <button type="button" class="btn btn-danger btn-sm remove-medicine"
                  value="<?php if (isset($this->request->getData('sadr_list_of_medicines')[$i]['id'])) {
                            echo $this->request->getData('sadr_list_of_medicines')[$i]['id'];
                          } ?>">
