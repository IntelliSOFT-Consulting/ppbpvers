			  ...
			  <tr>
				...
				<td>
					<div class="control-group"><?php
						echo $this->Form->control('Attachment.'.$i.'.id');
						echo $this->Form->control('Attachment.'.$i.'.model', array('type'=>'hidden', 'value'=> $model));
						echo $this->Form->control('Attachment.'.$i.'.group', array('type'=>'hidden', 'value'=> $group));
						echo $this->Form->control('Attachment.'.$i.'.filesize', array('type' => 'hidden'));
						echo $this->Form->control('Attachment.'.$i.'.basename', array('type' => 'hidden'));
						echo $this->Form->control('Attachment.'.$i.'.checksum', array('type' => 'hidden'));
						if (!empty($this->request->data['Attachment'][$i]['id']) &&
							...
							echo $this->Form->control('Attachment.'.$i.'.file', array(
				...
				<td>
					<?php
						if (!empty($this->request->data['Attachment'][$i]['id']) &&
							...
							echo $this->Form->control('Attachment.'.$i.'.description', array('type' => 'hidden'));
						} else {
							echo $this->Form->control('Attachment.'.$i.'.description', array(
