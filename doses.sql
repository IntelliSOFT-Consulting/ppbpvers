...
INSERT INTO `doses` (`value`, `icsr_code`, `name`, `created`, `modified`) VALUES
( 'mg', '003', 'mg', NULL, '2022-05-18 12:27:01'),
('ml', '012', 'ml', NULL, NULL),
( 'µg', '004', 'µg', NULL, NULL),
( 'g', '002', 'g', NULL, '2022-08-03 13:35:38'),
( 'Iu', '025', 'Iu', NULL, NULL),
('DF dosage form', '032', 'DF dosage form', NULL, NULL),
('Gtt drop(s)', '031', 'Gtt drop(s)', NULL, NULL),
('mmol', '023', 'mmol', NULL, NULL),
('meq', '029', 'meq', NULL, NULL),
('%', '030', '%', NULL, NULL),
('µCi', '020', 'µCi', NULL, NULL),
('µg/kg', '008', 'µg/kg', NULL, NULL),
('µg/m2', '010', 'µg/m2', NULL, NULL),
('µl', '013', 'µl', NULL, NULL),
('µmol', '024', 'µmol', NULL, NULL),
('Bq', '014', 'Bq', NULL, '2012-07-09 16:18:37'),
('Ci curie(s)', '018', 'Ci curie(s)', NULL, NULL),
('GBq', '015', 'GBq', NULL, NULL),
( 'iu/kg', '028', 'iu/kg', NULL, NULL),
('Kbq', '017', 'Kbq', NULL, NULL),
('kg', '001', 'kg', NULL, NULL),
('Kiu', '026', 'Kiu', NULL, NULL),
('l', '011', 'l', NULL, NULL),
('MBq', '016', 'MBq', NULL, NULL),
('mCi', '019', 'mCi', NULL, NULL),
('mg/kg', '007', 'mg/kg', NULL, NULL),
('mg/m2', '009', 'mg/m2', NULL, NULL),
('Miu', '027', 'Miu', NULL, NULL),
('Mol', '022', 'Mol', NULL, NULL),
( 'nCi', '021', 'nCi', NULL, NULL),
( 'ng', '005', 'ng', NULL, NULL),
( 'pg', '006', 'pg', NULL, NULL);
UPDATE doses SET created = CURRENT_TIMESTAMP,modified=CURRENT_TIMESTAMP;

TRUNCATE TABLE frequencies;
INSERT INTO `frequencies` (`value`, `name`) VALUES
('OD', 'OD (once daily)'),
('BD', 'BD (twice daily)'),
('TID.', 'TID. (three times a day)'),
('QID|QDS', 'QID|QDS (four times a day)'),
...
('1', 'Yearly'),
('Other', 'Other');
UPDATE frequencies SET created = CURRENT_TIMESTAMP,modified=CURRENT_TIMESTAMP;


TRUNCATE TABLE routes;
INSERT INTO `routes` (`id`, `value`, `name`, `icsr_code`, `created`, `modified`) VALUES
(2, 'oral', 'oral', '048', NULL, '2022-05-18 12:27:01'),
...
(13, 'auricular (otic)', 'auricular (otic)', '001', NULL, '2020-07-14 13:44:27'),
...
UPDATE routes SET created = CURRENT_TIMESTAMP,modified=CURRENT_TIMESTAMP;
...
INSERT INTO `vaccines` (`id`, `vaccine_name`, `description`, `health_program`, `created`, `modified`, `deleted`, `deleted_date`) VALUES
(1, 'COVID-19Vaccine-COVISHIELD', '', 'National Vaccines and immunisation program', '2021-02-01 11:24:29', '2021-04-28 19:06:50', 0, NULL),
(2, 'BCG', 'LYOPHILISED - Diluent\r\n20 dose per vial', 'National Vaccines and immunisation program', '2021-02-01 11:30:15', '2021-02-01 11:30:15', 0, NULL),
(3, 'Pentavalent  Vaccine (DTP-HepB-Hib)', '', 'National Vaccines and immunisation program', '2021-02-01 11:30:37', '2021-02-01 11:30:37', 0, NULL),
(4, 'Rota virus vaccine', '', 'National Vaccines and immunisation program', '2021-02-01 11:30:57', '2021-02-01 11:30:57', 0, NULL),
(5, 'Malaria (RTSS)Vaccine', '', 'National Vaccines and immunisation program', '2021-02-01 11:31:18', '2021-02-01 11:31:18', 0, NULL),
(6, 'Pneumococcal conjugate vaccine', '', 'National Vaccines and immunisation program', '2021-02-01 11:35:02', '2021-02-01 11:35:02', 0, NULL),
(7, 'Anti Snake venom', 'Lyophilised powder +Diluent - 1 dose per vial', 'National Vaccines and immunisation program', '2021-02-01 11:37:30', '2021-02-01 11:38:06', 0, NULL),
(8, 'Rabies vaccine', 'Liquid - 1 dose per vial', 'National Vaccines and immunisation program', '2021-02-01 11:38:53', '2021-02-01 11:39:04', 0, NULL),
(9, 'Hepatitis B Vaccine', 'liquid - 10 doses per vial', 'National Vaccines and immunisation program', '2021-02-01 11:39:42', '2021-02-01 11:39:42', 0, NULL),
(10, 'Tetanus Diptheria Vaccine', 'Liquid - 20 doses per vial', 'National Vaccines and immunisation program', '2021-02-01 11:40:24', '2021-02-01 11:40:24', 0, NULL),
(11, 'Yellow fever virus vaccine', 'Freeze Dried + Diluent - 10 doses per vial after mixing', 'National Vaccines and immunisation program', '2021-02-01 11:41:37', '2021-02-01 11:41:51', 0, NULL),
(12, 'Measles Rubella Vaccine', 'Freeze dried + Diluent - 10 doses per vial after mixing', 'National Vaccines and immunisation program', '2021-02-01 11:42:17', '2021-02-01 11:42:17', 0, NULL),
(13, 'Malaria (RTSS)Vaccine', 'Liquid +Lyophilised(pilot ) - 2 doses per vial after mixing', 'National Vaccines and immunisation program', '2021-02-01 11:42:48', '2021-02-01 11:42:48', 0, NULL),
(14, 'Bivalent oral Polio vaccine', 'Liquid Suspension - 20 doses per vial', 'National Vaccines and immunisation program', '2021-02-01 11:44:27', '2021-02-01 11:44:27', 0, NULL),
(15, 'Human Papiloma virus vaccine', 'Liquid - 1 dose per vial', 'National Vaccines and immunisation program', '2021-02-01 11:44:53', '2021-02-01 11:44:53', 0, NULL),
(16, 'Inactivated polio vaccine', 'Liquid - 10 doses per vial', 'National Vaccines and immunisation program', '2021-02-01 11:45:22', '2021-02-01 11:45:22', 0, NULL),
(17, 'Pneumococcal conjugate vaccine', 'Liquid - 4 doses per vial', 'National Vaccines and immunisation program', '2021-02-01 11:45:44', '2021-02-01 11:45:44', 0, NULL),
(18, 'Rota virus vaccine', '', 'National Vaccines and immunisation program', '2021-02-01 11:45:57', '2021-02-01 11:46:09', 1, '2021-02-01 11:46:09'),
(19, 'COVID-19Vaccine-COVISHIELD ', '', 'National Vaccines and immunisation program', '2021-03-29 12:39:21', '2021-03-29 12:39:21', 0, NULL),
(20, 'COVID-19 Vaccine-SPUTNIK V', '', 'National Vaccines and immunisation program', '2021-03-29 12:40:40', '2021-04-22 14:13:43', 0, NULL),
(21, 'COVID -19 Vaccine- VAXZEVRIA', '', 'National Vaccines and immunisation program', '2021-09-20 06:31:13', '2021-09-20 06:31:13', 0, NULL),
(22, 'COVID -19 Vaccine- ASTRAZENECA', '', 'National Vaccines and immunisation program', '2021-09-20 06:32:05', '2021-09-20 06:32:05', 0, NULL),
(23, 'COVID -19 Vaccine- MODERNA', '', 'National Vaccines and immunisation program', '2021-09-20 06:32:37', '2021-09-20 06:32:37', 0, NULL),
(24, 'COVID-19 Vaccine - PFIZER/BioNTech', '', 'National Vaccines and immunisation program', '2021-09-20 06:32:58', '2021-09-20 06:32:58', 0, NULL),
(25, 'COVID-19 Vaccine -  (JOHNSON&JOHNSONS)JANSSEN ', 'JANSSEN ', 'National Vaccines and immunisation program', '2021-09-20 06:33:37', '2021-09-20 06:33:37', 0, NULL),
(26, 'COVID -19 Vaccine- SINOPHARM', '', 'National Vaccines and immunisation program', '2021-09-20 06:33:47', '2021-09-20 06:33:47', 0, NULL);


UPDATE vaccines SET created = CURRENT_TIMESTAMP,modified=CURRENT_TIMESTAMP;
...
(250, NULL, NULL, NULL, '2022-05-31 13:00:36', '2022-05-31 13:00:36');
