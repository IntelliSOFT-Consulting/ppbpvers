...
// Configure the default date and time format
FrozenTime::setToStringFormat('yyyy-MM-dd HH:mm');  // For datetime with minutes
Time::setToStringFormat('yyyy-MM-dd HH:mm');        // For time with minutes
