$(document).ready(function () {
	...
	function constructTr(intId, field1) {
		...
		fieldWrapper.append(dose_dose_id);
		...
		myobj
			...
			.slideUp(300, function () {
				$(this).parent().parent().nextAll().each(function () {
					...
					$($(this).children().get(8)).find('input').prop('id', 'SadrListOfDrug' + intId + 'StartDate');
					$($(this).children().get(8)).find('input').prop('name', 'data[SadrListOfDrug][' + intId + '][start_date]');
					$($(this).children().get(8)).find('input').removeClass('hasDatepicker');
					$($(this).children().get(9)).find('input').prop('id', 'SadrListOfDrug' + intId + 'StopDate');
					$($(this).children().get(9)).find('input').prop('name', 'data[SadrListOfDrug][' + intId + '][stop_date]');
					$($(this).children().get(9)).find('input').removeClass('hasDatepicker');
					$($(this).children().get(10)).find('input').prop('id', 'SadrListOfDrug' + intId + 'Indication');
					$($(this).children().get(10)).find('input').prop('name', 'data[SadrListOfDrug][' + intId + '][indication]');
					$($(this).children().get(11)).find('input[type="hidden"]').prop('id', 'SadrListOfDrug' + intId + 'SuspectedDrug_');
					$($(this).children().get(11)).find('input[type="hidden"]').prop('name', 'data[SadrListOfDrug][' + intId + '][suspected_drug]');
					$($(this).children().get(11)).find('input[type="checkbox"]').prop('id', 'SadrListOfDrug' + intId + 'SuspectedDrug');
					$($(this).children().get(11)).find('input[type="checkbox"]').prop('name', 'data[SadrListOfDrug][' + intId + '][suspected_drug]');
